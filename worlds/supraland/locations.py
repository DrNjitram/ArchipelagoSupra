...
class LocationName(str, Enum):
    ...
    Chest106_8060 = "Blue Crystal - After Gate - High ledge next to Crystal - 1"
    ...
    Chest111_3 = "Blue Crystal - After Gate - High ledge next to crystal - 2"
    ...
    Chest163 = "Farm - behind breakable blocks"
    ...
    Chest19_6182 = "Red Crystal - Behind Planks in yellow Cave"
    ...
    Chest27_4172 = "Redville - Cave next to house with gun target"
    Chest28_4997 = "Desert 3 - above door to Desert2"
    Chest29_7214 = "Red Crystal - In Wood House with yellow crystals"
    ...
    Chest43 = "Red Crystal - Yellow cave on ledge next to door"
    ...
    Juicer2 = "Farm - Juicer in basement"
